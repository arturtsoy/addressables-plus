...
{
	[DisplayName("Google Asset Bundle Provider (Sync)")]
	public class GoogleAssetBundleSyncProvider : ResourceProviderBase
    {
	    public static bool handleSynchronously = false;

	    public override void Provide(ProvideHandle provideHandle)
	    {
		    Debug.LogFormat("[{0}.{1}] Type={2} Location={3} handleSynchronously={4}", nameof(GoogleAssetBundleSyncProvider), nameof(Provide), provideHandle.Type, provideHandle.Location, handleSynchronously);
