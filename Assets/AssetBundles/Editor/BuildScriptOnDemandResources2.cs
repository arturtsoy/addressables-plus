...
namespace UnityEditor.AddressableAssets.Build.DataBuilders
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "BuildScriptOnDemandResources.asset", menuName = "Addressables/Content Builders/OnDemandResources")]
    public class BuildScriptOnDemandResources : BuildScriptBase
    {
        /// <inheritdoc />
