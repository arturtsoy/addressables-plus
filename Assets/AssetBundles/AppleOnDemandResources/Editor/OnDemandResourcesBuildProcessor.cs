...
namespace AssetBundles.AppleOnDemandResources.Editor
{
    ...
    /// <summary>
    /// Moves custom asset pack data from their default build location <see cref="BuildScriptOnDemandResources"/> to their correct player build data location.
    ...
    public class OnDemandResourcesBuildProcessor : BuildPlayerProcessor
    {
        /// <summary>
    ...
    /// This script executes before the <see cref="AddressablesPlayerBuildProcessor"/> which moves all Addressables data to StreamingAssets.
    /// </summary>
    public class OnDemandResourcesBuildProcessor : IPreprocessBuildWithReport
    {
        /// <summary>
        /// Returns the player build processor callback order.
        /// </summary>
